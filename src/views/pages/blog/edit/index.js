...
const BlogEdit = () => {
  ...
  const categories = [
    ...
    { value: 'nimal', label: 'Nimal' },
    { value: 'kasun', label: 'Kasun' },
    { value: 'charles', label: 'Charles' },
    { value: 'rodrick', label: 'Rodrick' }
  ]
                  ...
                  <Row>
                    <Col md='6'>
                      <FormGroup className='mb-2'>
                        <Label for='blog-edit-title'>Term</Label>
                        ...
                        > 
                          <option value='Published'>1st Term</option>
                    ...
                    <Col md='6'>
                      <FormGroup className='mb-2'>
                        <Label for='blog-edit-category'>Name of Student</Label>
                        <Select
                    ...
                    <Col md='4'>
                      <FormGroup className='mb-2'>
                        <Label for='blog-edit-slug'>Subject 1</Label>
                        <Input id='blog-edit-slug'/>
                      </FormGroup>
                    </Col>
                    <Col md='4'>
                      <FormGroup className='mb-2'>
                        <Label for='blog-edit-slug'>Subject 2</Label>
                        <Input id='blog-edit-slug2'/>
                      </FormGroup>
                    </Col>
                    <Col md='4'>
                      <FormGroup className='mb-2'>
                        <Label for='blog-edit-slug'>Subject 3</Label>
                        <Input id='blog-edit-slug3'/>
                      </FormGroup>
                    </Col>
                    <Col md='4'>
                      <FormGroup className='mb-2'>
                        <Label for='blog-edit-slug'>Subject 4</Label>
                        <Input id='blog-edit-slug4'/>
                      </FormGroup>
                    </Col>
                    <Col md='4'>
                      <FormGroup className='mb-2'>
